...
export const metadata: Metadata = {
 ...
 icons: {
  icon: [{url:"/marshall-icon-192-v2.png",sizes:"192x192",type:"image/png"},{url:"/marshall-icon-512-v2.png",sizes:"512x512",type:"image/png"}],
  apple: [{url:"/marshall-apple-icon-v2.png",sizes:"180x180",type:"image/png"}],
 },
